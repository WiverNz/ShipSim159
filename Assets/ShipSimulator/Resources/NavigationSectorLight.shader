...
{
    Properties { [MainColor][HDR] _BaseColor("Light", Color)=(1,1,1,1) _SectorCenter("Sector bearing",Float)=0 _SectorArc("Sector arc",Float)=225 }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 _BaseColor;
            float _SectorCenter, _SectorArc;
            CBUFFER_END
