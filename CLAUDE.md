...
The Luch 14352 visual is authored in Blender. `Luch14352ModelIntegrator` imports its three
FBX LODs and updates only the visual child and model-dependent camera/light layout. The
Luch branch of the catalogue builder delegates to it, retaining the existing physics root.
See `Art/Source/Luch14352/README.md` for source references, axes and reconstruction limits.
